...
function parse(opts){
    var parser, elementParser, elementEndParser, node, way, tags, relations, wayNodeRefs, relationsMembers;
    ...
    if(opts.relation){
        ...
        elementParser.member = function(elem, attrs, prefix, uri, namespaces){
            ...
            if(type === 'way') {
                relationsMembers.ways.push(memberObj);
            } else if(type === 'node') {
                relationsMembers.nodes.push(memberObj);
            }
        };
