...
function createNodesView(pb, pg){
    ...
    function collectDeltaData(){
        var i, id, changeset, uid, userIndex, deltaDataList, deltaData, lat, lon;
    ...
    function get(i){
        ...
        node = {
            id: '' + nodeDeltaData.id,
            lat: 0.000000001 * (pb.lat_offset.toNumber() + (pb.granularity * nodeDeltaData.lat)),
            lon: 0.000000001 * (pb.lon_offset.toNumber() + (pb.granularity * nodeDeltaData.lon)),
            tags: tagsList[i]
        };
